...
% DoChiCalc_IO8.m
%
% Template for script to do chi calculations for IO8 CTD-chipod data. This is
% second step of CTD-chipod processing.
%
% *MakeCasts_CTDchipod_IO8.m needs to be run first*
%
...
%~~~~~~~~~~~~~~~~~~~~~
% ***
this_script_name='DoChiCalc_IO8.m'
...
Params.z_smooth=10;  % distance (m) over which to smooth N^2 and dT/dz
